/*
 * @(#)MongolHighContrastTheme.java	1.5 05/11/17
 *
 ...
 *
 * @version @(#)MongolHighContrastTheme.java	1.5 05/11/17
 * @author Michael C. Albers
 */
class MongolHighContrastTheme extends DefaultMongolTheme {
    ...
    boolean isSystemTheme() {
        return (getClass() == MongolHighContrastTheme.class);
    }
}
