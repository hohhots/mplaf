/*
 * @(#)MongolTitlePane.java	1.22 06/07/17
 *
 ...
 * @since 1.4
 */
class MongolTitlePane extends JComponent {
    ...
    private int state;
    /**
     * MongolRootPaneUI that created us.
     */
    private MongolRootPaneUI rootPaneUI;    // Colors
    ...
    private Color activeShadow = null;    // Bumps
    
    public MongolTitlePane(JRootPane root, MongolRootPaneUI ui) {
        this.rootPane = root;
        rootPaneUI = ui;
    ...
    /**
     * Adds any sub-Components contained in the <code>MongolTitlePane</code>.
     */
    ...
    /**
     * Installs the fonts and necessary properties on the MongolTitlePane.
     */
    ...
    private void addMenuItems(JMenu menu) {
        ...
        int mnemonic = MongolUtils.getInt("MongolTitlePane.restoreMnemonic", -1);
        ...
        mnemonic = MongolUtils.getInt("MongolTitlePane.iconifyMnemonic", -1);
        if (mnemonic != -1) {
            mi.setMnemonic(mnemonic);
        }
        ...
        if (Toolkit.getDefaultToolkit().isFrameStateSupported(
            ...
            mnemonic =
                    MongolUtils.getInt("MongolTitlePane.maximizeMnemonic", -1);
            if (mnemonic != -1) {
                mi.setMnemonic(mnemonic);
            }
        }
        ...
        mnemonic = MongolUtils.getInt("MongolTitlePane.closeMnemonic", -1);
        if (mnemonic != -1) {
            mi.setMnemonic(mnemonic);
        }
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (theTitle != null) {
            ...
            int xOffset = ((width - fm.getHeight()) / 2) + fm.getAscent();
            ...
            if (rect.y == 0) { //nm114
                rect.y = window.getHeight() - window.getInsets().bottom - 2; //nm114
            } //nm114

            titleH = rect.y - yOffset - 4; //nm114
            theTitle = SwingUtilities2.clipStringIfNecessary( //nm114
                    rootPane, fm, theTitle, titleH); //nm114

            int titleLength = SwingUtilities2.stringWidth(rootPane, fm,
                    theTitle);
            AffineTransform at = new AffineTransform();//nm114
            at.translate(width, 0);//nm114
            at.rotate(Math.PI / 2.0);//nm114
            g2.transform(at);//nm114
            SwingUtilities2.drawString(rootPane, g2, theTitle, yOffset,//nm114
                    xOffset);

            yOffset += titleLength + 5;
        }
    ...
    private class CloseAction extends AbstractAction {
        ...
        public CloseAction() {
            super(UIManager.getString("MongolTitlePane.closeTitle",
                    getLocale()));
        }
    ...
    private class IconifyAction extends AbstractAction {
        ...
        public IconifyAction() {
            super(UIManager.getString("MongolTitlePane.iconifyTitle",
                    getLocale()));
        }
    ...
    private class RestoreAction extends AbstractAction {
        ...
        public RestoreAction() {
            super(UIManager.getString("MongolTitlePane.restoreTitle", getLocale()));
        }
    ...
    private class MaximizeAction extends AbstractAction {
        ...
        public MaximizeAction() {
            super(UIManager.getString("MongolTitlePane.maximizeTitle",
                    getLocale()));
        }
    ...
    private class TitlePaneLayout implements LayoutManager {
        ...
        public void layoutContainer(Container c) {
            boolean leftToRight = Boolean.FALSE;

            int w = getWidth();
            int h = getHeight(); //nm114
            int x; 
            //int y = 3;
            int y;
            int spacing;
