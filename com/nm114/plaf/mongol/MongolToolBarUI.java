/*
 * @(#)MongolToolBarUI.java	1.42 05/11/30
 *
...
/**
 * A Mongol Look and Feel implementation of ToolBarUI.  This implementation 
 ...
 * @author Jeff Shapiro
 */
public class MongolToolBarUI extends BasicToolBarUI
{
    /**
    ...
    {
	return new MongolDockingListener( toolBar );
    }
        ...
        if (c.isOpaque() && (c.getBackground() instanceof UIResource) &&
            ...
            if (mb != null && mb.isOpaque() &&
                ...
                if (point.x == x && y == point.y + mb.getHeight() &&
                     ...
                     MongolUtils.drawGradient(c, g, "MenuBar.gradient",
            ...
            if (MongolUtils.drawGradient(c, g, "MenuBar.gradient",
    ...
    protected class MongolContainerListener
	extends BasicToolBarUI.ToolBarContListener {}

    // No longer used. Cannot remove for compatibility reasons
    protected class MongolRolloverListener 
	extends BasicToolBarUI.PropertyListener {}

    protected class MongolDockingListener extends DockingListener {
        private boolean pressedInBumps = false;

	public MongolDockingListener(JToolBar t) {
	    super(t);
	} 
	...
	public void mousePressed(MouseEvent e) { 
		...
		int x = MongolUtils.isLeftToRight(toolBar) ? 0 : toolBar.getSize().width-14;
	    ...
	    if (bumpRect.contains(e.getPoint())) {
	        pressedInBumps = true;
                ...
                if (!MongolUtils.isLeftToRight(toolBar)) {
    ...
    } // end class MongolDockingListener
}
