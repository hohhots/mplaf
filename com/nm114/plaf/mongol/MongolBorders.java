/*
 * @(#)MongolBorders.java	1.42 05/11/17
 *
...
/**
 * Factory object that can vend Borders appropriate for the mongol L & F.
 * @author Steve Wilson
 * @version 1.42 11/17/05
 */
public class MongolBorders {
    ...
    public static class Flush3DBorder extends AbstractBorder implements UIResource {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y,
                int w, int h) {
            if (c.isEnabled()) {
                MongolUtils.drawFlush3DBorder(g, x, y, w, h);
            } else {
                MongolUtils.drawDisabledBorder(g, x, y, w, h);
            }
        }
    ...
    public static class ButtonBorder extends AbstractBorder implements UIResource {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            ...
            if (model.isEnabled()) {
                ...
                if (isPressed && isDefault) {
                    MongolUtils.drawDefaultButtonPressedBorder(g, x, y, w, h);
                } else if (isPressed) {
                    MongolUtils.drawPressed3DBorder(g, x, y, w, h);
                } else if (isDefault) {
                    MongolUtils.drawDefaultButtonBorder(g, x, y, w, h, false);
                } else {
                    MongolUtils.drawButtonBorder(g, x, y, w, h, false);
                }
            } else { // disabled state
                MongolUtils.drawDisabledBorder(g, x, y, w - 1, h - 1);
            }
        }
        ...
        private void paintOceanBorder(Component c, Graphics g, int x, int y,
            ...
            g.translate(x, y);
            if (MongolUtils.isToolBarButton(button)) {
                if (model.isEnabled()) {
                    if (model.isPressed()) {
                ...
                if ((c instanceof JButton) && ((JButton) c).isDefaultButton()) {
                    ...
                    g.setColor(new ColorUIResource(0x333333)); //nm114
                    g.drawRect(x, y, x + w - 1, y + h - 1);

                    g.setColor(new ColorUIResource(0x577ca3)); //nm114
                    g.drawLine(x + 1, y + 1, x + w - 2, y + 1); //nm114
                    g.drawLine(x + 1, y + 1, x + 1, y + h - 2); //nm114

                    g.setColor(new ColorUIResource(0xadcede)); //nm114
                    g.drawLine(x + w - 2, y + 1, x + w - 2, y + h - 2); //nm114
                    g.drawLine(x + 2, y + h - 2, x + w - 3, y + h - 2); //nm114
    ...
    public static class InternalFrameBorder extends AbstractBorder implements UIResource {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y,
            ...
            if (c instanceof JInternalFrame && ((JInternalFrame) c).isSelected()) {
                background = MongolLookAndFeel.getPrimaryControlDarkShadow();
                highlight = MongolLookAndFeel.getPrimaryControlShadow();
                shadow = MongolLookAndFeel.getPrimaryControlInfo();
            } else {
                background = MongolLookAndFeel.getControlDarkShadow();
                highlight = MongolLookAndFeel.getControlShadow();
                shadow = MongolLookAndFeel.getControlInfo();
            }
    ...
    static class FrameBorder extends AbstractBorder implements UIResource {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y,
            ...
            g.setColor(new ColorUIResource(0x577ca3)); //nm114
            g.drawLine(x + w - 2, y + 1, x + w - 2, y + h - 1); //nm114
            g.drawLine(x + 2, y + h - 2, x + w - 3, y + h - 2); //nm114


            g.setColor(new ColorUIResource(0x333333)); //nm114
            g.drawLine(x + w - 1, y, x + w - 1, y + h); //nm114
            g.drawLine(x + 1, y + h - 1, x + w - 2, y + h - 1); //nm114

            g.setColor(background); //nm114
    ...
    static class DialogBorder extends AbstractBorder implements UIResource {
        ...
        protected Color getActiveBackground() {
            return MongolLookAndFeel.getPrimaryControlDarkShadow();
        }

        protected Color getActiveHighlight() {
            return MongolLookAndFeel.getPrimaryControlShadow();
        }

        protected Color getActiveShadow() {
            return MongolLookAndFeel.getPrimaryControlInfo();
        }

        protected Color getInactiveBackground() {
            return MongolLookAndFeel.getControlDarkShadow();
        }

        protected Color getInactiveHighlight() {
            return MongolLookAndFeel.getControlShadow();
        }

        protected Color getInactiveShadow() {
            return MongolLookAndFeel.getControlInfo();
        }
    ...
    public static class OptionDialogBorder extends AbstractBorder implements UIResource {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            ...
            switch (messageType) {
                ...
                default:
                    borderColor = MongolLookAndFeel.getPrimaryControlDarkShadow();
                    break;
            }
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            ...
            if (c.getParent() instanceof JMenuBar) {
                if (model.isArmed() || model.isSelected()) {
                    ...
                    g.setColor(MongolLookAndFeel.getMenuBackground());
    ...
    public static Border getButtonBorder() {
        if (buttonBorder == null) {
            buttonBorder = new BorderUIResource.CompoundBorderUIResource(
                    new MongolBorders.ButtonBorder(),
    ...
    public static Border getTextBorder() {
        if (textBorder == null) {
            textBorder = new BorderUIResource.CompoundBorderUIResource(
                    new MongolBorders.Flush3DBorder(),
                    new BasicBorders.MarginBorder());
        }
        return textBorder;
    }
    ...
    public static Border getTextFieldBorder() {
        if (textFieldBorder == null) {
            textFieldBorder = new BorderUIResource.CompoundBorderUIResource(
                    new MongolBorders.TextFieldBorder(),
                    new BasicBorders.MarginBorder());
        }
    ...
    public static Border getToggleButtonBorder() {
        if (toggleButtonBorder == null) {
            toggleButtonBorder = new BorderUIResource.CompoundBorderUIResource(
                    new MongolBorders.ToggleButtonBorder(),
                    new BasicBorders.MarginBorder());
        }
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            ...
            if (!c.isEnabled()) {
                ...
                if (model.isPressed() && model.isArmed()) {
                    ...
                    MongolUtils.drawDark3DBorder(g, x, y, w, h);
                } else {
                    MongolUtils.drawFlush3DBorder(g, x, y, w, h);
                }
            }
    ...
    public static Border getDesktopIconBorder() {
        return new BorderUIResource.CompoundBorderUIResource(
                new LineBorder(MongolLookAndFeel.getControlDarkShadow(), 1),
                new MatteBorder(2, 2, 1, 2, MongolLookAndFeel.getControl()));
    }
    ...
    static Border getToolBarRolloverBorder() {
        if (MongolLookAndFeel.usingOcean()) {
            return new CompoundBorder(
                    new MongolBorders.ButtonBorder(),
                    new MongolBorders.RolloverMarginBorder());
        }
        return new CompoundBorder(new MongolBorders.RolloverButtonBorder(),
                new MongolBorders.RolloverMarginBorder());
    }
    ...
    static Border getToolBarNonrolloverBorder() {
        ...
        return new CompoundBorder(new MongolBorders.ButtonBorder(),
                new MongolBorders.RolloverMarginBorder());
    }
}
