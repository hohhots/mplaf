/*
 * @(#)MongolRootPaneUI.java	1.23 06/01/30
 *
...
/**
 * Provides the Mongol look and feel implementation of <code>RootPaneUI</code>.
 * <p>
 * <code>MongolRootPaneUI</code> provides support for the
 * <code>windowDecorationStyle</code> property of <code>JRootPane</code>.
 * <code>MongolRootPaneUI</code> does this by way of installing a custom
 ...
 * @since 1.4
 */
public class MongolRootPaneUI extends BasicRootPaneUI {
     ...
     * to render the Mongol look and feel implementation of
    ...
    private JComponent createTitlePane(JRootPane root) {
        return new MongolTitlePane(root, this);
    }
    ...
    /**
     * Invoked when a property changes. <code>MongolRootPaneUI</code> is
    ...
    public void propertyChange(PropertyChangeEvent e) {
        ...
        if (propertyName.equals("windowDecorationStyle")) {
            ...
            // simpler. MongolTitlePane also assumes it will be recreated if
    ...
    private static class MongolRootLayout implements LayoutManager2 {
        ...
        public Dimension preferredLayoutSize(Container parent) {
            ...
            if (root.getWindowDecorationStyle() != JRootPane.NONE &&
                    (root.getUI() instanceof MongolRootPaneUI)) {
                JComponent titlePane = ((MongolRootPaneUI) root.getUI()).getTitlePane();
                if (titlePane != null) {
        ...
        public void layoutContainer(Container parent) {
            ...
            if (root.getWindowDecorationStyle() != JRootPane.NONE &&
                ...
                if (titlePane != null) {
                    ...
                    if (tpd != null) {
                        ...
                        titlePane.setBounds(0, 0, tpWidth, h); //nm114
                        //nextY += tpHeight;
                        nextX += tpWidth;
                    }
                }
            ...
            if (root.getMenuBar() != null) {
                ...
                root.getMenuBar().setBounds(nextX, 0, mbd.width, h);
                //nextY += mbd.height;
                nextX += mbd.width;
            }
            if (root.getContentPane() != null) {
                ...
                //h < nextY ? 0 : h - nextY);
                root.getContentPane().setBounds(nextX, 0, w < nextX ? 0: w - nextX,h);
            }
        }
