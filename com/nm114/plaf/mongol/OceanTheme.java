...
/**
 * The default theme for the {@code MongolLookAndFeel}.
 * <p>
 * The designers
 * of the Mongol Look and Feel strive to keep the default look up to
 ...
 */
public class OceanTheme extends DefaultMongolTheme {
    ...
    private static ColorUIResource WINDOWTITLEFOREGROUND =
            //new ColorUIResource( 148, 165, 206 );
            new ColorUIResource(0xeeeeee);
    private static ColorUIResource PRIMARYCONTROLSHADOW =
            new ColorUIResource(0x333333);
    private static ColorUIResource WINDOWTITLEINACTIVEBACKGROUND =
            new ColorUIResource(0xd4d0c8);
    private static ColorUIResource CONTROLSHADOW = PRIMARYCONTROLSHADOW;
    private static ColorUIResource BUTTONSELECT =
            new ColorUIResource(0xc4d7e9);    //private static ColorUIResource ButtonBorder = SECONDARY2;
    
    private static ColorUIResource ButtonBorder = PRIMARY3;
    
    private static ColorUIResource FOCUS_COLOR = new ColorUIResource(0xaccddd);
    ...
    public void addCustomEntriesToTable(UIDefaults table) {
        ...
        Object[] defaults = new Object[]{
            ...
            "MenuBarUI", "com.nm114.plaf.mongol.MongolMenuBarUI",
