...
/**
 * The Java Look and Feel, otherwise known as Mongol.
 * <p>
 * Each of the {@code ComponentUI}s provided by {@code
 * MongolLookAndFeel} derives its behavior from the defaults
 ...
 * <p>
 * {@code MongolLookAndFeel} derives it's color palette and fonts from
 * {@code MongolTheme}. The default theme is {@code OceanTheme}. The theme
 ...
 * theme was {@code DefaultMongolTheme}. The system property
 * {@code "swing.MongolTheme"} can be set to {@code "steel"} to indicate
 * the default should be {@code DefaultMongolTheme}.
 * <p> 6508895 680040256576
 ...
 *
 * @see MongolTheme
 * @see DefaultMongolTheme
 * @see OceanTheme
 *
 * @version @(#)MongolLookAndFeel.java	1.206 06/07/12
 * @author Steve Wilson
 */
public class MongolLookAndFeel extends BasicLookAndFeel {

    private static boolean MONGOL_LOOK_AND_FEEL_INITED = false;
    private static MongolTheme currentTheme;
    ...
    static boolean useSystemFonts() {
        if (isWindows() && useSystemFonts) {
            if (MONGOL_LOOK_AND_FEEL_INITED) {
                Object value = UIManager.get(
                        "Application.useSystemFontSettings");

                return (value == null || Boolean.TRUE.equals(value));
            }
            // If an instanceof MongolLookAndFeel hasn't been inited yet, we
    ...
    public String getDescription() {
        return "The nm114 Mongolian Look and Feel";
    }

    /**
     * Returns {@code false}; {@code MongolLookAndFeel} is not a native
     * look and feel.
     *
     * @return {@code false}
     */
    ...
    /**
     * Returns {@code true}; {@code MongolLookAndFeel} can be run on
     * any platform.
     *
     * @return {@code true}
     */
    ...
    /**
     * Returns {@code true}; Mongol can provide {@code Window}
     * decorations.
     *
     * @return {@code true}
     *
     ...
     * MongolLookAndFeel} registers an entry for each of the classes in
     * the package {@code com.nm114.plaf.mongol} that are named
     * MongolXXXUI. The string {@code XXX} is one of Swing's uiClassIDs. For
     * the {@code uiClassIDs} that do not have a class in Mongol, the
     * corresponding class in {@code javax.swing.plaf.basic} is
     * used. For example, Mongol does not have a class named {@code
     * "MongolColorChooserUI"}, as such, {@code
    ...
    protected void initClassDefaults(UIDefaults table) {
        ...
        final String MongolPackageName = "com.nm114.plaf.mongol.";

        Object[] uiDefaults = {
            "ButtonUI", MongolPackageName + "MongolButtonUI",
            /*"CheckBoxUI", MongolPackageName + "MongolCheckBoxUI",
            "ComboBoxUI", MongolPackageName + "MongolComboBoxUI",
            "DesktopIconUI", MongolPackageName + "MongolDesktopIconUI",
            "FileChooserUI", MongolPackageName + "MongolFileChooserUI",
            "InternalFrameUI", MongolPackageName + "MongolInternalFrameUI",
            */
            "LabelUI", MongolPackageName + "MongolLabelUI",
            /*"PopupMenuSeparatorUI", MongolPackageName + "MongolPopupMenuSeparatorUI",
            "ProgressBarUI", MongolPackageName + "MongolProgressBarUI",
            "RadioButtonUI", MongolPackageName + "MongolRadioButtonUI",
            "ScrollBarUI", MongolPackageName + "MongolScrollBarUI",
            "ScrollPaneUI", MongolPackageName + "MongolScrollPaneUI",
            "SeparatorUI", MongolPackageName + "MongolSeparatorUI",
            "SliderUI", MongolPackageName + "MongolSliderUI",
            "SplitPaneUI", MongolPackageName + "MongolSplitPaneUI",
            "TabbedPaneUI", MongolPackageName + "MongolTabbedPaneUI",
            "TextFieldUI", MongolPackageName + "MongolTextFieldUI",
            "ToggleButtonUI", MongolPackageName + "MongolToggleButtonUI",
            "ToolBarUI", MongolPackageName + "MongolToolBarUI",
            "ToolTipUI", MongolPackageName + "MongolToolTipUI",
            "TreeUI", MongolPackageName + "MongolTreeUI",
             */
            "RootPaneUI", MongolPackageName + "MongolRootPaneUI",
        };
     ...
     *         summary="Mongol's system color mapping"
     *         valign="top" >
     ...
     * </table>
     * The value {@code theme} corresponds to the current {@code MongolTheme}.
     * 
     * @param table the {@code UIDefaults} object the values are added to
     * @throws NullPointerException if {@code table} is {@code null}
     */
    protected void initSystemColorDefaults(UIDefaults table) {
        MongolTheme theme = getCurrentTheme();
        ...
        Object[] systemColors = {
            ...
            "buttonSelect", theme.getButtonSelect(), /* Border color for caption (title bar) window borders. */
    ...
    /**
     * Populates {@code table} with the defaults for Mongol.
     *
    ...
    protected void initComponentDefaults(UIDefaults table) {
        ...
        Color buttonSelect = getButtonSelect();
        ...
        Object textFieldBorder =
                new SwingLazyValue("com.nm114.plaf.mongol.MongolBorders",
                "getTextFieldBorder");

        Object dialogBorder = new MongolLazyValue(
                "com.nm114.plaf.mongol.MongolBorders$DialogBorder");

        Object questionDialogBorder = new MongolLazyValue(
                "com.nm114.plaf.mongol.MongolBorders$QuestionDialogBorder");
        ...
        Object scrollPaneBorder = new SwingLazyValue("com.nm114.plaf.mongol.MongolBorders$ScrollPaneBorder");
        Object buttonBorder =
                new MongolLazyValue("com.nm114.plaf.mongol.MongolBorders",
                "getButtonBorder");
        ...
        Object desktopIconBorder =
                new SwingLazyValue(
                "com.nm114.plaf.mongol.MongolBorders",
                "getDesktopIconBorder");

        Object menuBarBorder =
                new SwingLazyValue(
                "com.nm114.plaf.mongol.MongolBorders$MenuBarBorder");

        Object popupMenuBorder =
                new SwingLazyValue(
                "com.nm114.plaf.mongol.MongolBorders$PopupMenuBorder");
        Object menuItemBorder =
                new SwingLazyValue(
                "com.nm114.plaf.mongol.MongolBorders$MenuItemBorder");

        Object menuItemAcceleratorDelimiter = new String("-");
        Object toolBarBorder = new SwingLazyValue("com.nm114.plaf.mongol.MongolBorders$ToolBarBorder");
        ...
        Object[] defaults = {
            ...
            "Button.select", buttonSelect, //controlShadow,
            ...
            "CheckBox.icon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getCheckBoxIcon"),
            ...
            "RadioButton.icon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getRadioButtonIcon"),
            ...
            // File View 
            "FileView.directoryIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getTreeFolderIcon"),
            "FileView.fileIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getTreeLeafIcon"),
            "FileView.computerIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getTreeComputerIcon"),
            "FileView.hardDriveIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getTreeHardDriveIcon"),
            "FileView.floppyDriveIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getTreeFloppyDriveIcon"),
            // File Chooser
            "FileChooser.detailsViewIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getFileChooserDetailViewIcon"),
            "FileChooser.homeFolderIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getFileChooserHomeFolderIcon"),
            "FileChooser.listViewIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getFileChooserListViewIcon"),
            "FileChooser.newFolderIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getFileChooserNewFolderIcon"),
            "FileChooser.upFolderIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getFileChooserUpFolderIcon"),
            ...
            "Slider.horizontalThumbIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getHorizontalSliderThumbIcon"),
            "Slider.verticalThumbIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getVerticalSliderThumbIcon"),
            ...
            "InternalFrame.icon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getInternalFrameDefaultMenuIcon"),
            "InternalFrame.border", new SwingLazyValue("com.nm114.plaf.mongol.MongolBorders$InternalFrameBorder"),
            "InternalFrame.optionDialogBorder", new SwingLazyValue("com.nm114.plaf.mongol.MongolBorders$OptionDialogBorder"),
            "InternalFrame.paletteBorder", new SwingLazyValue("com.nm114.plaf.mongol.MongolBorders$PaletteBorder"),
            "InternalFrame.paletteTitleHeight", new Integer(11),
            "InternalFrame.paletteCloseIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory$PaletteCloseIcon"),
            "InternalFrame.closeIcon",
            new SwingLazyValue(
            "com.nm114.plaf.mongol.MongolIconFactory",
            ...
            SwingUtilities2.makeIcon(getClass(), MongolLookAndFeel.class,
            "icons/sortUp.png"),
            ...
            "com.nm114.plaf.mongol.MongolBorders$TableHeaderBorder"),
            // MenuBar
            ...
            "Menu.checkIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getMenuItemCheckIcon"),
            "Menu.arrowIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getMenuArrowIcon"),
            // Menu Item
            ...
            "MenuItem.checkIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getMenuItemCheckIcon"),
            "MenuItem.arrowIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getMenuItemArrowIcon"),
            ...
            // Option Pane Special Dialog Colors, used when MongolRootPaneUI
            ...
            "CheckBoxMenuItem.checkIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getCheckBoxMenuItemIcon"),
            "CheckBoxMenuItem.arrowIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getMenuItemArrowIcon"),
            ...
            "RadioButtonMenuItem.checkIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getRadioButtonMenuItemIcon"),
            "RadioButtonMenuItem.arrowIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getMenuItemArrowIcon"),
            ...
            "Tree.openIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getTreeFolderIcon"),
            "Tree.closedIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getTreeFolderIcon"),
            "Tree.leafIcon", new SwingLazyValue("com.nm114.plaf.mongol.MongolIconFactory", "getTreeLeafIcon"),
            "Tree.expandedIcon", new SwingLazyValue(
            "com.nm114.plaf.mongol.MongolIconFactory",
            "getTreeControlIcon",
            new Object[]{Boolean.valueOf(MongolIconFactory.DARK)}),
            "Tree.collapsedIcon", new SwingLazyValue(
            "com.nm114.plaf.mongol.MongolIconFactory",
            "getTreeControlIcon",
            new Object[]{Boolean.valueOf(MongolIconFactory.LIGHT)}),
            ...
            "ToolBar.rolloverBorder", new MongolLazyValue(
            "com.nm114.plaf.mongol.MongolBorders",
            "getToolBarRolloverBorder"),
            "ToolBar.nonrolloverBorder", new MongolLazyValue(
            "com.nm114.plaf.mongol.MongolBorders",
            ...
            // RootPane
            "RootPane.frameBorder", new MongolLazyValue(
            "com.nm114.plaf.mongol.MongolBorders$FrameBorder"),
            "RootPane.plainDialogBorder", dialogBorder,
            "RootPane.informationDialogBorder", dialogBorder,
            "RootPane.errorDialogBorder", new MongolLazyValue(
            "com.nm114.plaf.mongol.MongolBorders$ErrorDialogBorder"),
            ...
            "RootPane.warningDialogBorder", new MongolLazyValue(
            "com.nm114.plaf.mongol.MongolBorders$WarningDialogBorder"),
        ...
        if (isWindows() && useSystemFonts() && theme.isSystemTheme()) {
            ...
            Object messageFont = new MongolFontDesktopProperty(
                    "win.messagebox.font.height", kit, MongolTheme.CONTROL_TEXT_FONT);
    ...
    /**
     * Ensures the current {@code MongolTheme} is {@code non-null}. This is
     ...
     * @see MongolTheme#addCustomEntriesToTable(UIDefaults)
     */
    public UIDefaults getDefaults() {
        // PENDING: move this to initialize when API changes are allowed
        MONGOL_LOOK_AND_FEEL_INITED = true;
    ...
    /**
     * Set the theme used by <code>MongolLookAndFeel</code>.
     * <p>
     * After the theme is set, {@code MongolLookAndFeel} needs to be
     * re-installed and the uis need to be recreated. The following
     * shows how to do this:
     * <pre>
     *   MongolLookAndFeel.setCurrentTheme(theme);
     *
     ...
     * @see #getCurrentTheme
     */
    public static void setCurrentTheme(MongolTheme theme) {
        ...
        cachedAppContext.put("currentMongolTheme", theme);
    }

    /**
     * Return the theme currently being used by <code>MongolLookAndFeel</code>.
     ...
     * @since 1.5
     */
    public static MongolTheme getCurrentTheme() {
        AppContext context = AppContext.getAppContext();

        if (cachedAppContext != context) {
            currentTheme = (MongolTheme) context.get("currentMongolTheme");
            if (currentTheme == null) {
                // This will happen in two cases:
                // . When MongolLookAndFeel is first being initialized.
                ...
                if (useHighContrastTheme()) {
                    currentTheme = new MongolHighContrastTheme();
                } else {
                    // Create the default theme. We prefer Ocean, but will
                    // use DefaultMongolTheme if told to.
                    String theme = (String) AccessController.doPrivileged(
                            new GetPropertyAction("swing.MongolTheme"));
                    if ("steel".equals(theme)) {
                        currentTheme = new DefaultMongolTheme();
                    } else {
    ...
    public Icon getDisabledIcon(JComponent component, Icon icon) {
        if ((icon instanceof ImageIcon) && MongolLookAndFeel.usingOcean()) {
            return MongolUtils.getOceanDisabledButtonIcon(
     ...
     * @see MongolTheme
     */
    public static ColorUIResource getButtonSelect() {
        return getCurrentTheme().getButtonSelect();
    }
    ...
    public static ColorUIResource getButtonBorder() {
        return getCurrentTheme().getButtonBorder();
    }
    ...
    public LayoutStyle getLayoutStyle() {
        return MongolLayoutStyle.INSTANCE;
    }

    /**
     * MongolLazyValue is a slimmed down version of <code>ProxyLaxyValue</code>.
     * The code is duplicate so that it can get at the package private
     * classes in mongol.
     */
    private static class MongolLazyValue implements UIDefaults.LazyValue {
        ...
        MongolLazyValue(String name) {
            this.className = name;
        }

        MongolLazyValue(String name, String methodName) {
            this(name);
    ...
    /**
     * FontActiveValue redirects to the appropriate mongol theme method.
     */
    private static class FontActiveValue implements UIDefaults.ActiveValue {

        private int type;
        private MongolTheme theme;

        FontActiveValue(MongolTheme theme, int type) {
            this.theme = theme;
            this.type = type;
        }
        ...
        public Object createValue(UIDefaults table) {
            Object value = null;
            switch (type) {
                case MongolTheme.CONTROL_TEXT_FONT:
                    value = theme.getControlTextFont();
                    break;
                case MongolTheme.SYSTEM_TEXT_FONT:
                    value = theme.getSystemTextFont();
                    break;
                case MongolTheme.USER_TEXT_FONT:
                    value = theme.getUserTextFont();
                    break;
                case MongolTheme.MENU_TEXT_FONT:
                    value = theme.getMenuTextFont();
                    break;
                case MongolTheme.WINDOW_TITLE_FONT:
                    value = theme.getWindowTitleFont();
                    break;
                case MongolTheme.SUB_TEXT_FONT:
    ...
    private static class MongolLayoutStyle extends DefaultLayoutStyle {

        private static MongolLayoutStyle INSTANCE = new MongolLayoutStyle();
